namespace GOoDcast.Extensions
{
    ...
    public static class StreamExtensions
    {
        ...
        internal static async Task<byte[]> ReadFixedAsync(this Stream stream, int count, CancellationToken cancellationToken)
        {
            var buffer = new byte[count];
        ...
        internal static Task WriteByteAsync(this Stream stream, byte value)
        {
