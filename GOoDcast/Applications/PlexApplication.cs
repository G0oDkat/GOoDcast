namespace GOoDcast.Applications
{
    ...
    public class PlexApplication : MediaApplicationBase
    {
        ...
        //}
        //}
        private const string PlexApplicationId = "9AC194DC";

        public PlexApplication(IConnectionChannel connectionChannel, IReceiverChannel receiverChannel, IMediaChannel mediaChannel) : base(PlexApplicationId, connectionChannel, receiverChannel, mediaChannel)
        {
        }
    }
}
